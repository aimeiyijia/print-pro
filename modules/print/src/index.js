...
export default class Print {
  ...
  previewIfrmaeLoad() {
    let box = document.getElementById("pirnt-pro-previewBox")
  ...
  getBody() {
    let element = this.settings.element
    let el
    ...
    this.elsdom = this.beforeHanler(el)
  ...
  previewBox() {
    ...
    previewContent.setAttribute("id", "pirnt-pro-previewBox")
